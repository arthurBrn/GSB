...
<head>
	...
	<script language = "javascript" type="text/javascript">
		function verif_formulaire(){
			if((document.frmFormulaire.idFraisForfait.value != "") && (document.frmFormulaire.libelle.value != "") && (document.montant.prenom.value!="")){
				return true;
			}
			else{
...
<body>
	...
	<div id="form">
		<fieldset>
			<form name="frmFormulaire" action="../models/Ajouter/priveAjouterFFGSB.php" method=POST onSubmit="return verif_formulaire()">
					<p>Numéro</p>
